...
require("widgets/nvd3-widget/nvd3-widget");
...
require("widgets/v2.steps/post-process");

require("widgets/v2.steps/distribution-chart-decoration");

require("widgets/v2.nvd3-distribution/adapter");

var m = angular.module("app.widgets.v2.distribution-chart-wizard", ["app.widgets.nvd3-widget", "app.widgets.wizard", "app.widgets.v2.steps.edit-widget-id", "app.widgets.v2.steps.select-dataset", "app.widgets.v2.steps.make-query", "app.widgets.v2.steps.post-process", "app.widgets.v2.steps.distribution-chart-decoration", "app.widgets.v2.distribution-chart-adapter"]);

m._wizard = undefined;

m.factory("DistributionChartWizard", ["$http", "$modal", "NVD3Widget", "Wizard", "EditWidgetID", "SelectDataset", "MakeQuery", "PostProcess", "DistributionChartDecoration", "parentHolder", "DistributionAdapter", function ($http, $modal, NVD3Widget, Wizard, EditWidgetID, SelectDataset, MakeQuery, PostProcess, DistributionChartDecoration, parentHolder, DistributionAdapter) {
	if (!m._wizard) {
		m._wizard = new Wizard($modal).setTitle("Distribution Chart Settings Wizard").push(EditWidgetID).push(SelectDataset).push(MakeQuery).push(PostProcess).push(DistributionChartDecoration).onStart(function (wizard) {
			wizard.conf = {};
...
// }]);
//
//# sourceMappingURL=../v2.nvd3-distribution/wizard.js.map