      ...
      link: function link(scope, element, attrs) {
        ...
        scope.api = {
          ...
          refresh: function refresh() {
            ...
            if (scope.settings && scope.settings.options && scope.settings.data && (scope.options != scope.settings.options || scope.data != scope.settings.data)) {
          ...
          updateWithOptions: function updateWithOptions(options) {
...
//# sourceMappingURL=../v2.nvd3-widget/angular-nvd3-ext.js.map