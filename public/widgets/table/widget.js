...
require("widgets/table/data-widget");

require("widgets/data-dialogs/data-table-dialog");

require("widgets/data-util/adapter");

var m = angular.module("app.widgets.table", ["app.widgets.data-widget", "app.widgets.data-dialogs.data-table-dialog", "app.widgets.data-util.adapter"]);
...
m.controller("TableCtrl", ["$scope", "DataTableDialog", "DataWidget", "Normalizer", function ($scope, DataTableDialog, DataWidget, Normalizer) {
  new DataWidget($scope, {
    dialog: DataTableDialog,
    //decorationAdapter:DataTableDecorationAdapter,
    serieGenerator: {
      getData: function getData(table, scope) {
