...
var m = angular.module("app.widgets.v2.dm-ds-list", ["app.dictionary", "app.dps", "ngFileUpload", "react", "custom-react-directives"]);
m.controller("DataManagerSearchResultListController", ["$scope", "$http", "$dps", "EventEmitter", "APIProvider", "pageSubscriptions", "$lookup", "$translate", "$modal", "user", "i18n", function ($scope, $http, $dps, EventEmitter, APIProvider, pageSubscriptions, $lookup, $translate, $modal, user, i18n) {
...
//# sourceMappingURL=../v2.dm-ds-list/widget.js.map