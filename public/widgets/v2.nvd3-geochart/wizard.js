...
require("widgets/v2.nvd3-geochart/geochart-decoration");

require("widgets/v2.nvd3-geochart/adapter");

var m = angular.module("app.widgets.v2.geochart-wizard", [
// 'app.widgets.v2.nvd3-widget',
"app.widgets.wizard", "app.widgets.v2.steps.edit-widget-id", "app.widgets.v2.geochart-decoration", "app.widgets.v2.geochart-adapter"]);

m._wizard = undefined;

m.factory("GeochartWizard", ["$http", "$modal",
// "NVD3WidgetV2",
"Wizard", "EditWidgetID", "GeochartDecoration", "parentHolder", "GeochartAdapter", function ($http, $modal,
// NVD3WidgetV2,
Wizard, EditWidgetID, GeochartDecoration, parentHolder, GeochartAdapter) {
	if (!m._wizard) {
		m._wizard = new Wizard($modal).setTitle("Geochart Settings Wizard").push(EditWidgetID).push(GeochartDecoration).onStart(function (wizard) {
			wizard.conf = {};
...
//# sourceMappingURL=../v2.nvd3-geochart/wizard.js.map