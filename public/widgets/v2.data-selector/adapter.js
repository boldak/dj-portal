...
var m = angular.module("app.widgets.v2.bar-chart-adapter", ["app.widgets.v2.nvd3-widget"]);
      ...
      if (decoration.enableEmitEvents) {
        ...
        if (api) {
          ...
          api.onReady(function () {
            d3.select(api.getSVG()).selectAll(".nv-bar").style("cursor", "pointer");
          });
        }
        ...
        options.chart.multibar.dispatch = {
          elementClick: function elementClick(e) {
            ...
            var labels = d3.select(api.getSVG()).select(".nv-x").selectAll("text").style("fill", function (d) {
          ...
          elementDblClick: function elementDblClick(e) {
...
//# sourceMappingURL=../v2.data-selector/adapter.js.map