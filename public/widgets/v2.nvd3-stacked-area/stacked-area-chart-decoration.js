...
var m = angular.module("app.widgets.v2.steps.stacked-area-chart-decoration", ["app.widgets.v2.nvd3-widget", "app.widgets.v2.stacked-area-chart-adapter", "wizard-directives", "app.dps", "ng.ace"]);

m.factory("StackedAreaChartDecoration", ["$http", "$dps", "$q", "parentHolder", "StackedAreaAdapter", "pageWidgets", "i18n", "dialog", "$error", "dpsEditor", function ($http, $dps, $q, parentHolder, StackedAreaAdapter, pageWidgets, i18n, dialog, $error, dpsEditor) {

	var chartAdapter = StackedAreaAdapter;
...
//     }
// }]);
//# sourceMappingURL=../v2.nvd3-stacked-area/stacked-area-chart-decoration.js.map