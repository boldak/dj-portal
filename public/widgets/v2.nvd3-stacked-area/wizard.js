...
require("widgets/v2.nvd3-stacked-area/stacked-area-chart-decoration");

require("widgets/v2.nvd3-stacked-area/adapter");

var m = angular.module("app.widgets.v2.stacked-area-chart-wizard", [
// 'app.widgets.v2.nvd3-widget',
"app.widgets.wizard", "app.widgets.v2.steps.edit-widget-id", "app.widgets.v2.steps.stacked-area-chart-decoration", "app.widgets.v2.stacked-area-chart-adapter"]);

m._wizard = undefined;

m.factory("StackedAreaChartWizard", ["$http", "$modal",
// "NVD3WidgetV2",
"Wizard", "EditWidgetID", "StackedAreaChartDecoration", "parentHolder", "StackedAreaAdapter", function ($http, $modal,
// NVD3WidgetV2,
Wizard, EditWidgetID, StackedAreaChartDecoration, parentHolder, StackedAreaAdapter) {
	if (!m._wizard) {
		m._wizard = new Wizard($modal).setTitle("Stacked Area Chart Settings Wizard").push(EditWidgetID).push(StackedAreaChartDecoration).onStart(function (wizard) {
			wizard.conf = {};
...
//# sourceMappingURL=../v2.nvd3-stacked-area/wizard.js.map