...
var m = angular.module("app.widgets.v2.steps.chord-chart-decoration", ["app.widgets.v2.nvd3-widget", "app.widgets.v2.chord-chart-adapter", "wizard-directives", "app.dps", "ng.ace"]);

m.factory("ChordChartDecoration", ["$http", "$dps", "$q", "parentHolder", "NVD3ChordAdapter", "pageWidgets", "i18n", "dialog", "$error", "dpsEditor", function ($http, $dps, $q, parentHolder, NVD3ChordAdapter, pageWidgets, i18n, dialog, $error, dpsEditor) {

	var chartAdapter = NVD3ChordAdapter;
...
//# sourceMappingURL=../v2.nvd3-chord/chord-chart-decoration.js.map