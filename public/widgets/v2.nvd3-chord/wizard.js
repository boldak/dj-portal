...
require("widgets/v2.nvd3-chord/chord-chart-decoration");

require("widgets/v2.nvd3-chord/adapter");

var m = angular.module("app.widgets.v2.chord-chart-wizard", [
// 'app.widgets.v2.nvd3-widget',
"app.widgets.wizard", "app.widgets.v2.steps.edit-widget-id", "app.widgets.v2.steps.chord-chart-decoration", "app.widgets.v2.chord-chart-adapter"]);

m._wizard = undefined;

m.factory("ChordChartWizard", ["$http", "$modal",
// "NVD3Widget",
"Wizard", "EditWidgetID", "ChordChartDecoration", "parentHolder", "NVD3ChordAdapter", function ($http, $modal,
// NVD3Widget,
Wizard, EditWidgetID, ChordChartDecoration, parentHolder, NVD3ChordAdapter) {
		if (!m._wizard) {
				m._wizard = new Wizard($modal).setTitle("Chord Chart Settings Wizard").push(EditWidgetID).push(ChordChartDecoration).onStart(function (wizard) {
						wizard.conf = {};
...
//# sourceMappingURL=../v2.nvd3-chord/wizard.js.map