...
var m = angular.module("app.widgets.v2.steps.timeline-chart-decoration", ["app.widgets.v2.nvd3-widget", "app.widgets.v2.timeline-chart-adapter", "wizard-directives", "app.dps", "ng.ace"]);

m.factory("TimelineChartDecoration", ["$http", "$q", "$dps", "dialog", "appUrls", "parentHolder", "TimelineChartAdapter", "pageWidgets", "i18n", "$lookup", "EventEmitter", "dpsEditor", function ($http, $q, $dps, dialog, appUrls, parentHolder, TimelineChartAdapter, pageWidgets, i18n, $lookup, EventEmitter, dpsEditor) {

	var chartAdapter = TimelineChartAdapter;
		...
		loadData: function loadData() {
			...
			$q.all([thos.loadOptions().then(function (resp) {
				...
				thos.scopeStub = {
					...
					translations: i18n.translation(resp.data.value.dictionary.filter(function (item) {
...
//# sourceMappingURL=../v2.nvd3-timeline/timeline-chart-decoration.js.map