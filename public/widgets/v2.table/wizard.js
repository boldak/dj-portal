...
require("widgets/v2.steps/table-decoration");

var m = angular.module("app.widgets.v2.table-wizard", ["app.widgets.wizard", "app.widgets.v2.steps.edit-widget-id", "app.widgets.v2.steps.table-decoration"]);

m._wizard = undefined;

m.factory("TableWizard", ["$http", "$modal", "Wizard", "EditWidgetID", "TableDecoration", "parentHolder", function ($http, $modal, Wizard, EditWidgetID, TableDecoration, parentHolder) {
		if (!m._wizard) {
				m._wizard = new Wizard($modal).setTitle("Table Settings Wizard").push(EditWidgetID).push(TableDecoration).onStart(function (wizard) {
						wizard.conf = {};
...
//# sourceMappingURL=../v2.table/wizard.js.map