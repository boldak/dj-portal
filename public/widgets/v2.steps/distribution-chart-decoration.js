...
var m = angular.module("app.widgets.v2.steps.distribution-chart-decoration", ["app.widgets.v2.nvd3-widget", "app.widgets.v2.distribution-chart-adapter", "wizard-directives"]);

m.factory("DistributionChartDecoration", ["$http", "$q", "parentHolder", "DistributionAdapter", function ($http, $q, parentHolder, DistributionAdapter) {

	var chartAdapter = DistributionAdapter;
	...
	return {
		...
		setupOptions: function setupOptions() {
			...
			var $scope = this;
			var params = { serieAdapter: serieAdapter };
		...
		activate: function activate(wizard) {
			...
			if (!this.wizard.context.postprocessedTable) {
				$http.get("./api/data/process/" + this.conf.queryResultId).success(function (resp) {
...
//# sourceMappingURL=../v2.steps/distribution-chart-decoration.js.map