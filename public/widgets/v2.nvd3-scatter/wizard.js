...
require("widgets/v2.nvd3-scatter/scatter-chart-decoration");

require("widgets/v2.nvd3-scatter/adapter");

var m = angular.module("app.widgets.v2.scatter-chart-wizard", ["app.widgets.wizard", "app.widgets.v2.steps.edit-widget-id", "app.widgets.v2.steps.scatter-chart-decoration", "app.widgets.v2.scatter-chart-adapter"]);

m._wizard = undefined;

m.factory("ScatterChartWizard", ["$http", "$modal", "Wizard", "EditWidgetID", "ScatterChartDecoration", "parentHolder", "NVD3ScatterAdapter", function ($http, $modal, Wizard, EditWidgetID, ScatterChartDecoration, parentHolder, NVD3ScatterAdapter) {
	if (!m._wizard) {
		m._wizard = new Wizard($modal).setTitle("Scatter Chart Settings Wizard").push(EditWidgetID).push(ScatterChartDecoration).onStart(function (wizard) {
			wizard.conf = {};
...
//# sourceMappingURL=../v2.nvd3-scatter/wizard.js.map