...
require("widgets/v2.nvd3-line/line-chart-decoration");

require("widgets/v2.nvd3-line/adapter");

var m = angular.module("app.widgets.v2.line-chart-wizard", ["app.widgets.v2.nvd3-widget", "app.widgets.wizard", "app.widgets.v2.steps.edit-widget-id", "app.widgets.v2.steps.line-chart-decoration", "app.widgets.v2.line-chart-adapter"]);

m._wizard = undefined;

m.factory("LineChartWizard", ["$http", "$modal", "NVD3WidgetV2", "Wizard", "EditWidgetID", "LineChartDecoration", "parentHolder", "LineChartAdapter", function ($http, $modal, NVD3WidgetV2, Wizard, EditWidgetID, LineChartDecoration, parentHolder, LineChartAdapter) {
	if (!m._wizard) {
		m._wizard = new Wizard($modal).setTitle("Line Chart Settings Wizard").push(EditWidgetID).push(LineChartDecoration).onStart(function (wizard) {
			wizard.conf = {};
...
// }]);
//# sourceMappingURL=../v2.nvd3-line/wizard.js.map