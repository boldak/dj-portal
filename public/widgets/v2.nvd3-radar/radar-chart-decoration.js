...
var m = angular.module("app.widgets.v2.steps.radar-chart-decoration", ["app.widgets.v2.nvd3-widget", "app.widgets.v2.radar-chart-adapter", "wizard-directives", "app.dps", "ng.ace"]);

m.factory("RadarChartDecoration", ["$http", "$dps", "$q", "parentHolder", "RadarChartAdapter", "pageWidgets", "i18n", "dialog", "$error", "dpsEditor", function ($http, $dps, $q, parentHolder, RadarChartAdapter, pageWidgets, i18n, dialog, $error, dpsEditor) {

	var chartAdapter = RadarChartAdapter;
	...
	return {
		...
		loadData: function loadData() {
			...
			this.loadOptions().then(function (options) {
				...
				_this.options.chart.tooltipContent = function (serie, x, y, s) {
...
//     }
// }]);
//# sourceMappingURL=../v2.nvd3-radar/radar-chart-decoration.js.map