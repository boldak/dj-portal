...
var m = angular.module("app.widgets.v2.hbar-chart-adapter", []);
      ...
      if (decoration.enableEmitEvents) {
        ...
        if (api) {
          ...
          api.onReady(function () {
            d3.select(api.getSVG()).selectAll("g.nv-bar").style("cursor", "pointer");
          });
        }
...
//# sourceMappingURL=../v2.nvd3-bar-h/adapter.js.map