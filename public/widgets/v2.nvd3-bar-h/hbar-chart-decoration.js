...
var m = angular.module("app.widgets.v2.hbar-chart-decoration", ["app.widgets.v2.nvd3-widget", "app.widgets.v2.hbar-chart-adapter", "wizard-directives", "app.dps", "ng.ace"]);

m.factory("HBarChartDecoration", ["$http", "$dps", "$q", "parentHolder", "HBarChartAdapter", "pageWidgets", "i18n", "dialog", "$error", "dpsEditor", function ($http, $dps, $q, parentHolder, HBarChartAdapter, pageWidgets, i18n, dialog, $error, dpsEditor) {
...
// 	    }
// }]);
//# sourceMappingURL=../v2.nvd3-bar-h/hbar-chart-decoration.js.map