...
//
//
var skin = angular.module("app.skinDirectives", []);

skin.directive("designPanel", function () {
    return {
        restrict: "E",
...
skin.directive("applicationView", function () {
    return {
        restrict: "E",
...
skin.directive("pageListNav", function () {
    return {
        restrict: "E",
...
skin.directive("languageSelectorNav", function () {
    return {
        restrict: "E",
...
skin.directive("appLogo", function () {
    return {
        restrict: "E",
...
skin.directive("logoutButton", function () {
    return {
        restrict: "E",
...
skin.directive("loginGoogleButton", function () {
    return {
        restrict: "E",
...
skin.directive("prettyDps", function () {
    ...
    var markup = function markup(str) {
        if (!str || str == "") {
            return str;
        }var snippets = [];
        var s = str.replace(lookups.injection.re, function (match, index) {
            snippets.push("<span class=\"injection\">" + match.replace(lookups.lt.re, "&lt;").replace(lookups.gt.re, "&gt;") + "</span>");
...
skin.directive("highlight", function () {
    ...
    return {
        ...
        link: function link(scope, elm, attrs) {
            ...
            var render = function render(scope) {
                ...
                var highlighted = highlight.renderSync(scope.settings.data, new mode(), theme);

                ace.require("ace/lib/dom").importCssString(highlighted.css.replace("font-size: 12px;", "").replace(".ace_static_highlight .ace_gutter-cell:before {", ".ace_static_highlight .ace_gutter-cell:before { font-size: xx-small; padding-right: 0.5em; "), "ace_highlight");
...
//# sourceMappingURL=skin-directives.js.map