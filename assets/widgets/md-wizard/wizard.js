...
var m = angular.module("app.widgets.md-wizard",['oc.lazyLoad',"ng.ace",
            'ngMaterial', 
            'ngMessages',
            'ngSanitize']);

m.factory("MDWizard",["$ocLazyLoad", function($ocLazyLoad){
			...
			var s = this.parentScope;
			 ...
			 return new Promise((resolve,reject) => {
			        ...
			        this.modalInstance.show({
			            ...
			            templateUrl: '/widgets/md-wizard/wizard.html',
